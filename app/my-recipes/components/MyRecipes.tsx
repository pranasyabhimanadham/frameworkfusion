    ...
    <>
      <div className="max-w-screen-lg mx-auto px-5">
        ...
        >
          <Link
            href="/create-recipe"
            className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex mb-3"
          >
            Create recipe
            <svg
              xmlns="http://www.w3.org/2000/svg"
